...
class JsonToUi {
   ...
   * Take params
   */
  __init__(LogLevel: Logging['option']['level']['value'], comments: Comments[], config:JsonToUiConfig) {
    if(LogLevel > 4) console.log('JsonToUi.__init__')

    console.log('JsonToUi.__init__')
  }
   ...
   * `namespaces`. Data is being pulled and returned from `JsonToUi.contentGroups`.
   * @returns {boolean} True if successful, false if not.
   */
