 ...
 * @changelog 0.0.5 | 2023-07-22 | Erik Plachta | Finalized concept for toHtml functionality.
 *
...
class JsonToUi {
  ...
  constructor(
    ...
    this.getHtml = () => this.buildHtml(this.title, this.htmlConfig)
  }
   ...
   */
  buildHtml(title: string = 'No-Title-Set', htmlConfig: htmlConfig): string {
    ...
    // 2. Update the body
    document.body.classList.add('bg-gray-100', 'flex', 'flex-col', 'gap-8')
